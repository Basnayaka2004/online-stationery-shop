...
<section class="bg-white py-16">
    <div class="max-w-6xl mx-auto px-6 text-center">
        <h1 class="text-5xl font-extrabold text-slate-900 mb-4">Contact Us</h1>
        <p class="mt-4 text-slate-700 text-lg max-w-3xl mx-auto font-medium leading-relaxed">
            Reach out to us anytime — we’re happy to assist you with your stationery needs.
        </p>
    </div>
</section>
...
<section class="bg-blue-50 py-16">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-8 text-center">
        ...
        <div class="bg-white border border-blue-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all">
            ...
            <h2 class="text-xl font-bold text-slate-900 mb-3">Our Address</h2>
        ...
        <div class="bg-white border border-blue-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all">
            <div class="text-4xl mb-4">📧</div>
            <h2 class="text-xl font-bold text-slate-900 mb-3">Email Us</h2>
            <p class="text-slate-700 font-medium leading-relaxed">
                support@magicquill.com<br>
                info@magicquill.com
            </p>
        </div>
        ...
        <div class="bg-white border border-blue-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all">
            <div class="text-4xl mb-4">📞</div>
            <h2 class="text-xl font-bold text-slate-900 mb-3">Call Us</h2>
            <p class="text-slate-700 font-medium leading-relaxed">
                +94 77 123 4567<br>
                +94 11 234 5678
            </p>
...
<section class="bg-white py-16">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 class="text-3xl font-bold text-slate-900 mb-6">Working Hours</h2>
        <p class="text-slate-700 text-lg font-medium leading-relaxed">
            Monday – Saturday: <span class="font-bold text-blue-600">9:00 AM – 6:00 PM</span><br>
            Sunday & Public Holidays: <span class="font-bold text-red-600">Closed</span>
        </p>
    </div>
</section>
